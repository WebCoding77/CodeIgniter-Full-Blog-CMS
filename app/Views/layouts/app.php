				...
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						...
						<div class="col-8 text-center">
							...
							<ul class="navbar-nav mr-auto js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
								...
								<?php if(isset(auth()->user()->id)) : ?>
									<li><a href="<?php echo base_url('posts/create-posts'); ?>">Create Post</a></li>
								<?php endif; ?>
								<li><a href="<?php echo url_to('contact'); ?>">Contact Us</a></li>
								<li><a href="<?php echo url_to('about'); ?>">About Us</a></li>
                                ...
                                <?php else: ?>   
                                    ...
                                    <li class="has-children">
											...
											<ul class="dropdown">
												<li><a href="<?php echo url_to('my.posts'); ?>">My Posts</a></li>
						...
						<div class="col-2 text-end">
							...
							<form action="<?php echo url_to('search.post'); ?>" method="POST" class="search-form d-none d-lg-inline-block">
